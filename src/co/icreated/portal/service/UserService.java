...
public class UserService {
  ...
  public SessionUser findSessionUserByValue(String value) {
    ...
    String sql = "SELECT AD_User_ID, u.Value, u.Name, Email, "
        ...
        + "u.isLocked, u.isActive, bp.isActive " + "FROM AD_User u "
    ...
    try {
      ...
      if (rs.next()) {
        sessionUser = new SessionUser(rs.getInt(1), rs.getString(2), rs.getString(3),
            rs.getString(4), rs.getString(5), rs.getString(6), rs.getInt(7),
            rs.getString(8).equals("N"), rs.getString(9).equals("N"), true,
            rs.getString(10).equals("Y") && rs.getString(11).equals("Y"));
      }
    } catch (Exception e) {
    ...
    // rs.getString(9).equals("N"), true, rs.getString(10).equals("Y") &&
    // rs.getString(11).equals("Y"))
    // );
