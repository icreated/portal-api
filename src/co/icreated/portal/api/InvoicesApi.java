...
public interface InvoicesApi {
  ...
  /**
   * GET /invoices/{id} : Get invoice Get invoice by id
   *
   * @param id Invoice id (required)
   * @return OK (status code 200) or Bad Request (status code 400) or Unauthorized (status code 401)
   *         or Forbidden (status code 403) or Not Found (status code 404) or Internal Server Error
   *         (status code 500)
   */
  @Operation(operationId = "getInvoice", summary = "Get invoice", tags = {"invoices"},
      responses = {
  ...
  /**
   * GET /invoices : Get invoices Get user invoices
   *
   * @return OK (status code 200) or Bad Request (status code 400) or Unauthorized (status code 401)
   *         or Forbidden (status code 403) or Not Found (status code 404) or Internal Server Error
   *         (status code 500)
   */
  @Operation(operationId = "getInvoices", summary = "Get invoices", tags = {"invoices"},
      responses = {
          @ApiResponse(responseCode = "200", description = "OK",
              content = {@Content(mediaType = "application/json",
          ...
          @ApiResponse(responseCode = "404", description = "Not Found"),
          @ApiResponse(responseCode = "500", description = "Internal Server Error")})
  @RequestMapping(method = RequestMethod.GET, value = "/invoices", produces = {"application/json"})
  ...
  /**
   * GET /invoices/openitems : Get open items Get open items
   *
   * @return OK (status code 200) or Bad Request (status code 400) or Unauthorized (status code 401)
   *         or Forbidden (status code 403) or Not Found (status code 404) or Internal Server Error
   *         (status code 500)
   */
  @Operation(operationId = "getOpenItems", summary = "Get open items", tags = {"invoices"},
      responses = {
          @ApiResponse(responseCode = "200", description = "OK",
              content = {@Content(mediaType = "application/json",
                  schema = @Schema(implementation = OpenItemDto.class))}),
          @ApiResponse(responseCode = "400", description = "Bad Request"),
          @ApiResponse(responseCode = "401", description = "Unauthorized"),
          @ApiResponse(responseCode = "403", description = "Forbidden"),
          @ApiResponse(responseCode = "404", description = "Not Found"),
          @ApiResponse(responseCode = "500", description = "Internal Server Error")})
  @RequestMapping(method = RequestMethod.GET, value = "/invoices/openitems",
      produces = {"application/json"})
