...
public interface UsersApi {
    ...
    @RequestMapping(
        ...
        value = "/users/password/change",
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    ResponseEntity<UserDto> changePassword(
        @Parameter(name = "PasswordDto", description = "Change password", required = true) @Valid @RequestBody PasswordDto passwordDto
    );


    /**
     * POST /users/password/emaillink : Send email link
     * Send email link
     *
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = "/users/password/emaillink",
        consumes = { "application/json" }
    )
    ResponseEntity<Void> sendEmailLink(
        @Parameter(name = "CommonStringDto", description = "Token", required = true) @Valid @RequestBody CommonStringDto commonStringDto
    );


    /**
     * POST /users/password/validate : Validate token
     * Validate token
     *
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = "/users/password/validate",
        consumes = { "application/json" }
    )
    ResponseEntity<Void> validateToken(
        @Parameter(name = "PasswordDto", description = "Validate new password", required = true) @Valid @RequestBody PasswordDto passwordDto
    );
