...
public class QueryTool {
  ...
  public static <T> List<T> nativeList(String sql, Map<Integer, Object> params,
      ThrowingFunction<ResultSet, T, Exception> lambdaFunction) {
    ...
    try {
      ...
      rs = pstmt.executeQuery();
      while (rs.next()) {
        retValue.add(lambdaFunction.apply(rs));
      }
    } catch (Exception e) {
      log.log(Level.SEVERE, sql, e);
    } finally {
