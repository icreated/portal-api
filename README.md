...
# Icreated Portal API (IPA) for ERP OpenSource Idempiere
> 
...
From a functional point of view this IPA provides following features:

*	API-first product-centric approach 
*	Automatic generated models with openapi-generator maven plugin
